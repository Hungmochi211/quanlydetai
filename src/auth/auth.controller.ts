import { Body, Controller, Post, HttpCode, HttpStatus, UseGuards, Get, Request, Put } from "@nestjs/common";
...
export class AuthCotroller {
    ...
    @Post('resetpassword')
    reset(@Body('token') token: string, @Body('newPassword') newPassword: string,) {
