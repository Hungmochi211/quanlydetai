...
import {
  CreateAcceptanceDossierDto,
  FinalizeAcceptanceDto,
  SubmitAcceptanceScoreDto,
  UpdateAcceptanceDossierDto,
} from 'src/dto/AcceptanceDto';
...
export class AcceptanceController {
  ...
  @Post('project/:maDT') create(
    @Param('maDT') maDT: string,
    @Body() dto: CreateAcceptanceDossierDto,
    @Request() req: any,
  ) {
    return this.service.createDraft(maDT, dto, this.account(req));
  }
  @Get('project/:maDT') findByProject(
    @Param('maDT') maDT: string,
    @Request() req: any,
  ) {
  ...
  @Patch(':id') update(
    ...
    @Body() dto: UpdateAcceptanceDossierDto,
    @Request() req: any,
  ) {
  ...
  @Post(':id/scores') score(
    @Param('id', ParseIntPipe) id: number,
    @Body() dto: SubmitAcceptanceScoreDto,
    @Request() req: any,
  ) {
  ...
  @Post(':id/finalize') finalize(
    @Param('id', ParseIntPipe) id: number,
    @Body() dto: FinalizeAcceptanceDto,
    @Request() req: any,
  ) {
